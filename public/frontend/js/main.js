...
function activateNavbar() {
    ...
    // Check if the page has been scrolled down 100px
...
(function($) {
    ...
    hamburger_menu.addEventListener("click", function(){
        nav_menu_container.classList.add('active_sidebar');
    })

    drawer_close.addEventListener("click", function(){
        nav_menu_container.classList.remove('active_sidebar');
    })
    ...
    $(".clients-carouseltwo").owlCarousel({
        autoplay: true,
        autoplayTimeout: 2000,
        navigation: false,
        margin: 10,

            ...
            <div class="h-100 card card-body rounded p-4 pb-0">
                <div class="d-flex justify-content-between" >
                    ...
                    <a type="button" data-toggle="modal" data-target="#mainSlider" class="btn-sm btn btn-primary"
                       style="color:white;"> + Create Banner</a>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var bannerInfo = $('#bannerInfo').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('administrator.banner.data') !!}',
                columns: [{
                    data: 'id'
                }, {
                    data: 'banner_image',
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if (data.status == 1) {
                                return '<button type="button" class="btn btn-success btn-sm btn-status" data-status="0"  id="bannerStatusBtn"   data-id="' +
                                    data.id + '">Active</button>';
                            } else {
                                return '<button type="button" class="btn btn-warning btn-sm btn-status" data-status="1" id="bannerStatusBtn" data-id="' +
